...
# ============================================
# КОМАНДА: /помощь (С кнопками Принять/Отказ)
# ============================================
...
class HelpButtonsView(discord.ui.View):
    ...
    @discord.ui.button(label="✅ Принять", style=discord.ButtonStyle.success, custom_id="accept", emoji="✅")
    async def accept_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            title="✅ Вопрос принят в работу",
            description=f"Вопрос от {self.user.mention} принят!",
            color=COLORS['success']
        )
        embed.add_field(name="👤 Обрабатывает", value=interaction.user.mention, inline=True)
        embed.add_field(name="🕐 Время", value=discord.utils.format_dt(datetime.now(), 'F'), inline=True)
        embed.set_footer(text="✦ KURAI • Вопрос в обработке")
